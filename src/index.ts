        ...
        const shellHtml = `<!DOCTYPE html>
            ...
            <head>
                ...
                <style>
                    ...
                    #root { isolation: isolate; background: transparent !important; width: 232px !important;max-width: 232px !important;}
                    .js-warning { font-family: sans-serif; color: #999; font-size: 12px; }
                </style>
            </head>
            <body style="background: transparent !important; margin: 0 !important; padding: 0 !important;width: 232px !important;max-width: 232px !important;">
